...
const App = () => {
  ...
  return (
    <div className="relative w-full h-screen">
        ...
        <div 
        className="absolute top-4 left-4 flex items-center border border-gray-300/20 justify-center rounded-lg shadow-lg text-xl bg-slate-50/20 px-4 py-2 backdrop-blur-xs z-20">
          SeismoMap
        </div>
