...
import { Layers, CalendarDays, Activity, Globe } from 'lucide-react';
...
const App = () => {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div 
        className={`absolute top-4 left-4 flex items-center justify-center gap-2 font-bold text-lg sm:text-2xl sm:px-4 py-1 z-10 ${
          activeLayer.id === 'openstreetmap' ? 'text-gray-700' : 'text-white'
        }`}
      >
      <img src="logo.png" alt="Blog Logo" width={30} height={30} />
      <div>GeoQuake</div>
      </div>
