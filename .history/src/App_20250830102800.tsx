            ...
            <div className="absolute top-0 right-12 mt-0 bg-slate-50 border border-gray-200 rounded-lg shadow-lg overflow-hidden min-w-42">
              ...
              {mapLayers.map((layer) => (
                <button
                  ...
                  className={`w-full cursor-pointer flex items-center gap-3 px-4 py-2 text-left hover:bg-gray-50 transition-colors duration-150 ${
                    activeLayer === layer 
            ...
            <div className="absolute top-0 right-12 mt-0 bg-slate-50 border border-gray-200 rounded-lg shadow-lg overflow-hidden min-w-42">
              ...
              {timeRangeOptions.map((option) => (
                <button
                  ...
                  className={`w-full cursor-pointer flex items-center justify-between px-4 py-2 text-left hover:bg-gray-50 transition-colors duration-150 ${
          ...
          {isInfoOpen && (
            <div className="absolute top-0 right-12 mt-0 bg-slate-50 border border-gray-200 rounded-lg shadow-lg overflow-hidden min-w-42">
              ...
              {mapLayers.map((layer) => (
                <button
                  key={layer.id}
                  className={`w-full flex items-center gap-3 px-4 py-2 text-left hover:bg-gray-100 transition-colors duration-150 ${
                    activeLayer === layer 
                      ? 'bg-indigo-50 text-indigo-600' 
                      : 'text-gray-700'
                  }`}
