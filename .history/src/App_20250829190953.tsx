...
const App = () => {
  ...
  return (
    <div className="relative w-full h-screen">
        ...
        <div 
        className="absolute top-4 left-4 flex items-center text-slate-50 font-bold border border-gray-300/20 justify-center rounded-lg shadow-lg text-xl bg-slate-50/20 px-4 py-1 backdrop-blur-xs z-20">
          GeoQuake
        </div>
