...
const App = () => {
  ...
  return (
    <div className="relative w-full h-screen">
        ...
        className="absolute top-4 left-4 flex items-center border border-gray-300 justify-center rounded-lg shadow-lg bg-slate-50/30 px-4 py-2 backdrop-blur-xs z-20">
          SeismoMap
        </div>
