...
const App = () => {
  ...
  return (
    <div className="relative w-full h-screen">
        ...
        <div 
        className={`absolute top-4 left-4 flex items-center justify-center gap-2 font-bold text-2xl px-4 py-1 z-10 ${activeLayer.id === 'satelite'}?'text-slate-50':'text-gray-700'`}>
          <Earth />
          <div>GeoQuake</div>
        </div>
