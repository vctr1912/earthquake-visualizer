...
import { Layers, CalendarDays, Activity, Globe, TrendingUp, Zap, SquareActivity } from 'lucide-react';
...
const App = () => {
  ...
  return (
    <div className="relative w-full h-screen">
        ...
        <div 
          className={`absolute top-4 left-4 flex items-center justify-center gap-2 font-bold text-2xl px-4 py-1 z-10 ${
            activeLayer.id === 'openstreetmap' ? 'text-gray-700' : 'text-white'
          }`}
        >
<SquareActivity /><div>GeoQuake</div>
        </div>
