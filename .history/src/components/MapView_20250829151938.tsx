...
import { Map, Layers, Satellite, Globe, CalendarDays, Activity } from 'lucide-react';
      ...
      <div className="absolute top-4 right-4 z-10 flex flex-col gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="bg-purple-200 hover:bg-gray-50 border border-gray-300 rounded-lg p-3 shadow-lg transition-all duration-200 hover:shadow-xl"
          ...
          {isLayerSelectorOpen && (
            <div className="absolute top-0 right-12 mt-0 bg-gray-100 border border-gray-200 rounded-lg shadow-lg overflow-hidden min-w-42">
        ...
        <div className="relative">
          ...
          {isTimeRangeOpen && (
            <div className="absolute top-0 right-12 mt-0 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden min-w-42">
              <div className="px-4 py-2 bg-gray-50 border-b border-gray-200">
