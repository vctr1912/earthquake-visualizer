      ...
      <Popup>
        <div className="">
          ...
          <div className="flex gap-4 mb-1">
            <div className="text-gray-600 text-sm flex"><div className="font-medium">Magnitude: </div> {earthquake.magnitude}</div>
            <div className="text-gray-600 text-sm flex"><div className="font-bold">Depth: </div> {earthquake.position[2]}</div>
          </div>
