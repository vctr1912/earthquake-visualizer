...
import { Map, Layers, Satellite, Globe, CalendarDays } from 'lucide-react';
    ...
    <div className="relative w-full h-screen">
      ...
      <div className="absolute top-4 right-4 z-10 flex flex-col gap-3">
        ...
        <div className="relative">
          ...
          {isMagnitudeOpen && (
            <div className="absolute top-0 right-12 mt-0 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden min-w-44">
              <div className="px-4 py-2 bg-gray-50 border-b border-gray-200">
