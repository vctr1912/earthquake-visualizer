    ...
    <div className="relative w-full h-screen">
      ...
      <div className="absolute top-4 right-4 z-10 flex flex-col gap-3">
        ...
        <div className="relative">
          ...
          {isLayerSelectorOpen && (
            <div className="absolute top-0 right-12 mt-0 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden min-w-48">
        ...
        <div className="relative">
          <button
            ...
            className="bg-white hover:bg-gray-50 border border-gray-300 rounded-lg px-3 py-2 shadow-lg transition-all duration-200 hover:shadow-xl"
            title="Select time range"
          >
            <span className="text-sm font-medium text-gray-700">
              {timeRangeOptions.find(option => option.id === activeTimeRange)?.name}
            </span>
          </button>

          {/* Time Range Options Dropdown */}
          {isTimeRangeOpen && (
            <div className="absolute top-0 right-12 mt-0 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden min-w-36">
              <div className="px-4 py-2 bg-gray-50 border-b border-gray-200">
        ...
        <div className="relative">
          ...
          >
            <span className="text-sm font-medium text-gray-700">
              {magnitudeOptions.find(option => option.id === activeMagnitude)?.name}
            </span>
          </button>
